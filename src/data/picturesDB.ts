...
import image5 from '/images/feed/26/нинель и кошка.png'
import image6 from '/images/feed/25/характер2.png'
import image7 from '/images/feed/26/солдаты.png'
